...
| 20 | `platform/20-connectivity-hub` | Hub VNet, AVNM, Azure Firewall + Policy, ExpressRoute GW, DDoS plan, Private DNS Resolver |
...
- **AVNM** manages connectivity config, security admin rules, and UDR/NSG for
  all spokes centrally.
